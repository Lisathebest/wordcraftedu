...
function Header() { return <header className="topbar"><a className="brand" href="#" aria-label="Wordcraft Classroom home"><span className="brand-logo-frame"><img className="brand-logo" src="/wordcraft-logo-transparent.png" alt="Wordcraft Classroom" /></span></a><span className="pill">For teachers &amp; active students</span></header>; }
...
function Setup({ mode, setMode, names, setNames, learnerLevel, setLearnerLevel, wordFocus, setWordFocus, durationMinutes, setDurationMinutes, startMatch, studentLink, setStudentLink, studentJoined, studentJoinNotice, onJoinTeacherLink, shareUrl, shareNotice, onCreateStudentLink, onCopyStudentLink, customWords, linkedClassWords, classFolders, activeFolder, selectedLibraryIds, folderNameDraft, setFolderNameDraft, libraryQuery, setLibraryQuery, libraryLevel, setLibraryLevel, libraryTopic, setLibraryTopic, folderNotice, folderFileInputRef, libraryWords, onSelectFolder, onNewFolder, onCreateFolder, onSaveFolder, onDeleteFolder, onToggleLibraryWord, onSelectVisibleWords, onClearVisibleWords, onImportFolder, onExportFolder, studioDraft, setStudioDraft, studioNotice, importInputRef, onImport, onImportFile, onGenerate, onGenerateBatch, onDelete, generatingWordId, illustrationBatch }: SetupProps) {
  ...
  return <main className="app-shell"><Header />
    <div className="hero teacher-hero">
      ...
      <section className="hero-art round-guide" aria-labelledby="round-guide-title">
        <div className="round-guide-kicker"><span>How to play</span><span>one timed round</span></div>
        <h2 id="round-guide-title">Build a campus with words.</h2>
        <ol className="round-guide-steps">
          <li><span className="round-guide-number">1</span><div><b>Pick</b><small>Choose 1–4 words from your shelf.</small></div></li>
          <li><span className="round-guide-number">2</span><div><b>Make a sentence</b><small>Type or say one clear sentence using every chosen word.</small></div></li>
          <li><span className="round-guide-number">3</span><div><b>Build</b><small>A correct word starts or upgrades a place. A recipe pair unlocks a special building.</small></div></li>
        </ol>
        <div className="round-guide-win"><span aria-hidden="true">★</span><div><b>How to win</b><small>When time runs out, the highest World score is Top Builder. Solo play ends with a score and review list.</small></div></div>
      </section>
    </div>
