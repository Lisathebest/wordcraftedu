const ILLUSTRATION_STYLE_PROMPT = [
  ...
  "Style/medium: the fixed Wordcraft house style is a cute hand-drawn crayon-and-marker doodle, like a children's sticker illustration. Use a thick, slightly uneven black or charcoal ink contour, simple cheerful flat color fills, visible rough crayon texture, very little shading, and a charmingly simple graphic look.",
  "Face rule: when the subject can show a face, the face is required directly on that subject, including inanimate objects. Draw exactly two solid black bean-shaped dot eyes, one tiny curved mouth, and two small soft pink blush dots. Keep the requested object recognizable and never add a separate animal or character just to carry the face.",
